from calvincTools.blueprints import ctools_bp
from calvincTools.cMenu.routes import register_menu_blueprint
from calvincTools.usr_auth.routes import register_auth_blueprint
from calvincTools.usr_auth.views import init_login_manager
from calvincTools.utils import checkTemplate_and_render
from calvincTools.utils.routes import register_util_blueprint
...
class calvincTools_init:
    ...
    def __init__(self,
        ...
        if app is not None:
            self.init_app(app, app_db, cTools_bind_key, cTools_tablenames, cTools_models)

    def init_app(self, app, app_db, cTools_bind_key=None, cTools_tablenames=None, cTools_models=None):
